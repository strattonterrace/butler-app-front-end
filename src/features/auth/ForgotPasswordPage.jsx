...
export default function ForgotPasswordPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSent(true)
            toast.success('Reset email sent!', { description: 'Check your inbox for a reset link.' })
        } catch (error) {
                        ...
                        <div style={{ textAlign: 'center', padding: '16px 0' }}>
                            ...
                            <p style={{ fontSize: 13, color: '#71717A' }}>
                                ...
                                <button
                                    ...
                                    style={{ color: '#C9A84C', background: 'none', border: 'none', cursor: 'pointer', fontWeight: 500, fontSize: 13 }}
                                >
                                    Try again
                                </button>
                            </p>
